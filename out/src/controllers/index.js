...
const googleLogin_1 = __importDefault(require("./user/googleLogin"));
...
const searchByKeyWord_1 = __importDefault(require("./job/searchByKeyWord"));
...
const searchByKeyWord_2 = __importDefault(require("./news/searchByKeyWord"));
...
const searchByKeyWord_3 = __importDefault(require("./grant/searchByKeyWord"));
...
const searchByKeyWord_4 = __importDefault(require("./blog/searchByKeyWord"));
...
(function (Controller) {
    ...
    Controller.userGoogleLogin = googleLogin_1.default;
    ...
    Controller.searchJobsByKeyWord = searchByKeyWord_1.default;
    // -- Job category -- //
    ...
    Controller.searchNewsByKeyWord = searchByKeyWord_2.default;
    // -- Grant -- //
    ...
    Controller.searchGrantsByKeyWord = searchByKeyWord_3.default;
    // -- Blog -- //
    ...
    Controller.searchBlogsByKeyWord = searchByKeyWord_4.default;
    // -- Service Provider -- //
