...
exports.default = async (req, res) => {
    ...
    try {
        ...
        let year_of_experience_lower_bound = (0, lodash_1.parseInt)(req.query.year_of_experience_lower_bound) ||
            req.body?.year_of_experience?.lower_bound;
        let year_of_experience_upper_bound = (0, lodash_1.parseInt)(req.query.year_of_experience_upper_bound) ||
            req.body?.year_of_experience?.upper_bound;
        let category = !req.query.category
            ? undefined
            : JSON.parse(req.query.category) || req.body.category;
        let closing_date_lower_bound = req.query.closing_date_lower_bound ||
            req.body?.closing_date?.lower_bound;
        let closing_date_upper_bound = req.query.closing_date_upper_bound ||
            req.body?.closing_date?.upper_bound;
        ...
        let salary_low_end = parseFloat(req.query.salary_low_end) ||
            req.body?.salary?.low_end;
