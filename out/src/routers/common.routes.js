...
router.post("/forgot-password/get-confirmation-code", common_1.default.forgotPassword, index_1.default.sendEmail);
...
router.post("/get-post-url", [index_1.default.tokenAuth, index_1.default.uploadFile().single("post")], common_1.default.getPostUrl);
