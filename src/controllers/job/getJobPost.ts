...
export default async (req: Request, res: Response) => {
  ...
  try {
    ...
    let year_of_experience_lower_bound =
      parseInt(req.query.year_of_experience_lower_bound as string) ||
      req.body?.year_of_experience?.lower_bound;
    let year_of_experience_upper_bound =
      parseInt(req.query.year_of_experience_upper_bound as string) ||
    ...
    let closing_date_lower_bound =
      (req.query.closing_date_lower_bound as string) ||
      req.body?.closing_date?.lower_bound;
    let closing_date_upper_bound =
      (req.query.closing_date_upper_bound as string) ||
    ...
    let salary_low_end =
      parseFloat(req.query.salary_low_end as string) ||
