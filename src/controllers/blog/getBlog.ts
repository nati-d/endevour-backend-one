...
export default async (req: Request, res: Response) => {
    try {
        ...
        return res.status(400).json(new ApiResponse(false, "error while validating request"));
    }
    ...
    try {
        ...
        res.status(201).json(new ApiResponse(true, "blog gotted successfully", newBlog));
