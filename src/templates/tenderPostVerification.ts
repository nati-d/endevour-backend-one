const tenderPostVerification = (userName: any) => {
  return `<html>
<head>
    <title>Tender Confirmation</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2>Tender Confirmation</h2>
        </div>

        <p>Dear ${userName},</p>

        <div class="message">
            <p>We are pleased to confirm that your tender submission has been reviewed and successfully posted on our website.</p>
...
export default tenderPostVerification;
